...
| File | Purpose | Status |
|------|---------|--------|
| [main.level.json](./main.level.json) | Ground floor — living, kitchen, entry, stairs | **Owner measurements** |
| [upper.level.json](./upper.level.json) | Top floor — 3 beds, hall bath, master ensuite | **Owner measurements** |
| [basement.level.json](./basement.level.json) | Basement bedroom + laundry | **Owner measurements** |
| [garage.level.json](./garage.level.json) | Garage | TBD |
| [exterior.level.json](./exterior.level.json) | Doorbell zone + perimeter coverage band | Virtual only |

**Parity intake:** [../parity/measurements.json](../parity/measurements.json) · [../../docs/PARITY-DATA-COLLECTION.md](../../docs/PARITY-DATA-COLLECTION.md)
