...
Normative Matter integration boundary (D-12). Implements **FR1–FR5**, **FR30–FR32**, **FR-H1**; ADR-MA-01–04; [`architecture.md`](../../architecture.md) MatterAdapterPort. Traceability: [`../FR-COVERAGE.md`](../FR-COVERAGE.md).
