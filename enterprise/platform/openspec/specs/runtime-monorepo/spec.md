# runtime-monorepo Specification

## Purpose

npm workspaces layout for **FR42**, **FR40** (deployment/secrets docs); engine, LCARS, packages under `enterprise/runtime/`. Traceability: [`../FR-COVERAGE.md`](../FR-COVERAGE.md).
