# lcars-environmental Specification

## Purpose

Environmental loop LCARS surface — **FR2**, **FR3**, **FR13**; setpoint control, freshness, QuickEnvPin (W-CT-04). Traceability: [`../FR-COVERAGE.md`](../FR-COVERAGE.md).
