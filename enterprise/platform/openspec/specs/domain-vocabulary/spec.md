...
Canonical ENTERPRISE domain terms (**FR24** station IDs, OutcomeType, AlertPhase). All other specs MUST use these definitions. Traceability: [`../FR-COVERAGE.md`](../FR-COVERAGE.md).
