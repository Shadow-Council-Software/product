...
Engine ↔ LCARS (and future bridge-station) contract. Implements **FR-H3**, **FR33–FR37**, **FR43**; architecture REST/WS surface. Traceability: [`../FR-COVERAGE.md`](../FR-COVERAGE.md).
